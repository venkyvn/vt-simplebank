...
// SQLStore SqlStore provides all functions to execute SQL queries and transaction
...
// It creates a transfer record, add account entries,update account's balance within a simple database transaction
